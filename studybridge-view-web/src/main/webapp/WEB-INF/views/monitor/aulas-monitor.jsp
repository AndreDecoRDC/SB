...
<body>
<header class="header">
    <a href="${pageContext.request.contextPath}/monitor/monitor-dashboard.jsp" class="brand">
        <div class="logo">SB</div><strong>StudyBridge</strong>
    </a>
    <nav class="nav">
        <a class="btn" href="${pageContext.request.contextPath}/monitor/aulas-monitor.jsp">Aulas</a>
        <a class="btn" href="${pageContext.request.contextPath}/monitor/horarios.jsp">Horários</a>
        <a class="btn" href="${pageContext.request.contextPath}/monitor/perfil-monitor.jsp">Perfil</a>
        <a class="notif" href="#notifPanel">
            <img src="${pageContext.request.contextPath}/Imagens/notifications_24dp_1E3FAE_FILL0_wght400_GRAD0_opsz24.svg" alt="Notificações">
        </a>
        ...
        <div class="aulas-section">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn-denunciar" href="#"
                           data-denunciado-id="idDoAlunoJoao"
                           data-aula-id="idDaAulaJoao">
                            <img src="${pageContext.request.contextPath}/Imagens/report_23dp_1E3FAE_FILL0_wght400_GRAD0_opsz24.svg" alt="Denunciar">
                        </a>
                    </td>
                </tr>
